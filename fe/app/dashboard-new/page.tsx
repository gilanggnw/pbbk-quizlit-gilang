...
// import { QuizService, getDifficultyColor, getDifficultyLabel } from '../lib/quiz-service';
...
//   useEffect(() => {
//     const loadedQuizzes = QuizService.getAllQuizzes();
...
//     e.preventDefault();
//     if (editingQuiz) {
//       const updatedQuiz = QuizService.updateQuiz(editingQuiz.id, editingQuiz);
//       if (updatedQuiz) {
...
//       const success = QuizService.deleteQuiz(id);
//       if (success) {
...
//                 Create
//               </Link>
//               <Link href="/dashboard-new" className="text-white font-medium">
//                 My Quizzes
//               </Link>
