...
export default function StartQuiz({ params }: { params: Promise<{ id: string }> }) {
  ...
  const getScoreResult = () => {
    return calculateQuizScore(selectedAnswers, questions);
  };

  if (showResults) {
    const scoreResult = getScoreResult();
    const { score, percentage } = scoreResult;
      ...
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="bg-gray-800 rounded-lg p-8 max-w-md w-full mx-4">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6">Great job on completing the quiz</p>
            
            <div className="bg-gray-700 rounded-lg p-4 mb-6">
              <div className="text-3xl font-bold text-white mb-2">{percentage}%</div>
              <div className="text-gray-300">
                {score} out of {scoreResult.total} correct
              </div>
            </div>
